...
3. Wait a minute, visit the published URL — should be `https://yourusername.github.io/NZBHydra2Console/`

### 2. Configure CORS on NZBHydra
...
3. Set the allowed origin to your GitHub Pages origin (no path), e.g. `https://yourusername.github.io`
...
**"CORS or network error"** — see step 2 above. Your NZBHydra needs to allow your GitHub Pages origin.
